...
```
2567 % cuedo fmt 2567.cue  -d
cuedo format 2567.cue -d
••• runParseAndFormat ----------------------------------------
••• 2024-02-10 18:12:32
••• input: 2567.cue
foo: [
...
Available Commands:
  ...
  formatFromJson Reads cue test cases from json and parses and formats them
  help           Help about any command
  version        Print the version data
...
Usage:
  cuedo format <inputfile>.cue [flags]

Aliases:
  format, fmt

Flags:
  -k, --fbb_kludge                               formatting: enable a kludge in parser to anticipate a fix for the issue #2567
  -x, --formatter_hexdump                        formatting: print a hex dump of the formatter's internal buffer, for each fragment when printed
  -f, --formatter_stacktrace                     formatting: print the stack trace for each fragment when printed
  -m, --full_monty                               turn on everything
  -n, --parser_ast_node_type_and_comments        parsing: print the AST node type and comments (and DebugStr) while creating nodes
  -w, --parser_ast_spew                          parsing: deep pretty print the AST tree
  -a, --parser_ast_tree                          parsed: print the final AST tree
  -c, --parser_comments_pos                      parsing: print the comment position and text while creating nodes
  -s, --parser_comments_stack                    parsing: print the comments stack while creating nodes
  -d, --parser_debug_str                         parsed: print the final AST debug string
  -p, --parser_stack_trace                       parsing: print the parser stack trace while creating nodes
  -o, --parser_token                             parsing: print the parser token while creating nodes
  -t, --parser_trace                             parsing: print the parser.Trace while creating nodes
  -b, --process_both_with_and_without_comments   process both with and without comments
